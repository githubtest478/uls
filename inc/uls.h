...
enum e_flagset {
    ...
    flag_one    =   ((uint32_t)0x00000002U),    //-1 force output to be one entry per line.
    ...
    flag_C      =   ((uint32_t)0x00000010U),    //-C Force multi-column output
    ...
    flag_x      =   ((uint32_t)0x00040000U),    //-x The same as -C, except that the multi-column output is produced with entries sorted across, rather than down, the columns.
